...
class cmdString(object):
    ...
    def __init__(self):
        self.command = []
        self.command_string = ""
        self.L = JLog.PrintLog(Log="C:\\Temp\\PhotoLogToolbar_LOG.txt", Indent=6)
...
##    cmd = cmdString()
##    cmd.AddStringInQuotes(sys.executable)
##    cmd.AddStringInQuotes(r'R:\Personal Folders\Deters\Programming\MyPythonPackages\Mapped_Photo_Log\Test Projects\Stewart Project\2016-06-14 - Site Visit\Mapped Photo Log\Mapped Photo Log.mxd')
##    cmd.Batch()
    mxd = (r'R:\Personal Folders\Deters\Programming\MyPythonPackages\Mapped_Photo_Log\Test Projects\Stewart Project\2016-06-14 - Site Visit\Mapped Photo Log\Mapped Photo Log.mxd')
    subprocess.Popen(mxd,shell=True)
