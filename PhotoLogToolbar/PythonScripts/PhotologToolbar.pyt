...
class rotatePhoto:
    def __init__(self):
        """Define the tool (tool name is the name of the class)."""
        self.label = "Rotate Photograph 90 Degrees Clockwise"
        self.canRunInBackground = False
        self.description = "Rotate the currnet photo 90 degrees clockwise, change the orientation value, and update the Field of View polygon accordingly."
    ...
    def execute(self, parameters, messages):
        ...
        # Execute function
        rotateImage.Main(CurrentPhoto=restrict_setting)
        return
